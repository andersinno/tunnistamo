...
from .views import ADFSOAuth2Adapter, EspooADFSOAuth2Adapter, HelsinkiADFSOAuth2Adapter, TampereADFSOAuth2Adapter
...
urlpatterns += get_urlpatterns(TampereADFSOAuth2Adapter)
